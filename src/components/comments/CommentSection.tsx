    ...
    <div>
      <div className="flex items-center gap-2 mb-6">
        ...
        <h2 className="text-lg font-bold text-brand-ink">
          {l.comments}
          {/* Round 29: suppress the (N) count while a load error is
              on-screen. Otherwise the header reads `(0)` next to a
              "couldn't load" message — the two contradict each other
              and a customer reads `(0)` as "post has no engagement"
