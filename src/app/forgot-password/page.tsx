...
/**
 * "Forgot password" form. Sends a recovery email via Supabase Auth.
 *
 * The `redirectTo` is the canonical /auth/callback handler with
 * `next=/auth/reset-password` so the user lands on the password-update
 * form after the code exchange completes. Building the URL on the
 * client guarantees we use the actual origin the visitor came in on
 * (production vs preview vs local), avoiding a class of bugs where a
 * hardcoded URL silently sends people to the wrong environment.
 */
        ...
        <main className="flex-1 w-full flex items-center justify-center px-4 py-16 animate-in fade-in duration-500">
          <div className="w-full max-w-sm">
            <div className="text-center mb-10">
              ...
              <h1 className="text-2xl font-extrabold tracking-tight text-[#111111] mb-2">
                비밀번호 찾기
              </h1>
