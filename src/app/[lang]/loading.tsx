export default function Loading() {
  return (
    <>
      <div className="w-full h-[440px] sm:h-[600px] bg-neutral-100 animate-pulse" />
      ...
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6 pt-16 md:pt-24">
        <div className="flex flex-col items-center mb-12">
          ...
          <div className="h-3 w-16 bg-neutral-100 rounded animate-pulse mt-3" />
        </div>
        <div className="flex flex-wrap justify-center gap-x-4 gap-y-12 lg:gap-x-8">
          {[0, 1, 2].map(i => (
            <div key={i} className="w-[calc(50%-0.5rem)] lg:w-[calc(25%-1.5rem)]">
              <div className="aspect-[5/6] bg-neutral-100 animate-pulse rounded-[16px] mb-4" />
              <div className="space-y-2 px-1">
                ...
                <div className="h-4 bg-neutral-200 rounded animate-pulse w-1/3 mt-2" />
              </div>
            </div>
          ))}
        </div>
