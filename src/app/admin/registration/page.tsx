      ...
      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
        ...
        {openSection === 'fields' && (
          <div className="p-5 pt-0 space-y-4">
            ...
            <div className="border border-dashed border-gray-300 rounded-lg p-4">
              ...
              <div className="grid grid-cols-4 gap-2">
                ...
                <div className="flex gap-2">
                  ...
                  <button onClick={addField} disabled={!newField.key || !newField.label_kr} className="bg-[#111] text-white px-3 rounded-lg text-xs font-semibold disabled:opacity-30 hover:bg-black transition">
            ...
            <button onClick={saveFields} disabled={saving === 'fields'} className={`px-6 py-2.5 rounded-lg font-semibold text-sm transition-all flex items-center gap-2 ${saved === 'fields' ? 'bg-green-500 text-white' : 'bg-[#111] text-white hover:bg-black'} disabled:opacity-50`}>
      ...
      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
        ...
        {openSection === 'verification' && (
          <div className="p-5 pt-0 space-y-4">
            ...
            <button onClick={saveVerification} disabled={saving === 'verification'} className={`px-6 py-2.5 rounded-lg font-semibold text-sm transition-all flex items-center gap-2 ${saved === 'verification' ? 'bg-green-500 text-white' : 'bg-[#111] text-white hover:bg-black'} disabled:opacity-50`}>
              <Save className="w-4 h-4" />
