    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2 pt-2 border-t border-gray-100">
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-[#111] text-white text-xs font-bold tracking-wider rounded-lg hover:bg-black transition"
        >
