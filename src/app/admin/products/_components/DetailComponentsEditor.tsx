...
import { Upload, GripVertical, Trash2, Film, Image as ImgIcon, Eye } from 'lucide-react';
...
const MAX_DETAIL_FILE_SIZE = 30 * 1024 * 1024; // 30MB soft cap (confirm to proceed past it)
 ...
 * sortable card (image / video upload OR YouTube URL) and renders a live
 * preview that matches the storefront's stack layout. Replaces the legacy
