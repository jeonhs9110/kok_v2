 ...
 * answers the marketing team's questions instead:
 ...
 * side in useAnalyticsData — pageviews collapse into runs of activity
 * from the same ip_hash with no >30min gap. Bounce rate, engagement,
 * landing-page, and channel-quality all fall out of that construction.
 */
